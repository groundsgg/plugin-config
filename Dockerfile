...
# Velocity plugin from /jar/plugin.jar. GitHub Packages credentials arrive as
# a BuildKit secret and are never retained in an image layer.
...
RUN mkdir -p paper example-paper example-velocity
